...
Unsere Datenschutzerklärung wurde zuletzt am 6. Oktober 2018 geändert. <!-- TODO: Offer PDF once privacy policy is finalized. -->
...
Wir respektieren die [Do Not Track (DNT)-Einstellung](https://www.eff.org/issues/do-not-track), die Du in Deinem Browser setzen kannst. Wenn Du diese aktiviert hast, deaktivieren wir sämtliche Telemetrie (aktuell findet keine statt, aber wir werden in der Zukunft evtl. datenschutzfreundliche Telemetrie implementieren). <!-- TODO: Change if we implement telemetry. -->
